...
export const CommentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationSqlApp.comment.delete.question">
        <Translate contentKey="jhipsterSampleApplicationSqlApp.comment.delete.question" interpolate={{ id: commentEntity.id }}>
