  ...
  return (
    <div>
      <h2 id="comment-heading" data-cy="CommentHeading">
        <Translate contentKey="jhipsterSampleApplicationSqlApp.comment.home.title">Comments</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="jhipsterSampleApplicationSqlApp.comment.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/comment/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhipsterSampleApplicationSqlApp.comment.home.createLabel">Create new Comment</Translate>
          </Link>
        </div>
      </h2>
        ...
        {commentList && commentList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="jhipsterSampleApplicationSqlApp.comment.id">ID</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('nickName')}>
                  <Translate contentKey="jhipsterSampleApplicationSqlApp.comment.nickName">Nick Name</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('nickName')} />
                </th>
                <th className="hand" onClick={sort('commentText')}>
                  <Translate contentKey="jhipsterSampleApplicationSqlApp.comment.commentText">Comment Text</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('commentText')} />
                </th>
                <th>
                  <Translate contentKey="jhipsterSampleApplicationSqlApp.comment.book">Book</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterSampleApplicationSqlApp.comment.home.notFound">No Comments found</Translate>
            </div>
          )
        )}
      </div>
