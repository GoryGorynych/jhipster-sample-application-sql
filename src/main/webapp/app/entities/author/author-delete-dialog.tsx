...
export const AuthorDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationSqlApp.author.delete.question">
        <Translate contentKey="jhipsterSampleApplicationSqlApp.author.delete.question" interpolate={{ id: authorEntity.id }}>
