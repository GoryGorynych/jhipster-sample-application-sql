...
export const BookDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationSqlApp.book.delete.question">
        <Translate contentKey="jhipsterSampleApplicationSqlApp.book.delete.question" interpolate={{ id: bookEntity.id }}>
