  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplicationSqlApp.book.home.createOrEditLabel" data-cy="BookCreateUpdateHeading">
            <Translate contentKey="jhipsterSampleApplicationSqlApp.book.home.createOrEditLabel">Create or edit a Book</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplicationSqlApp.book.name')}
                id="book-name"
                name="name"
                data-cy="name"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterSampleApplicationSqlApp.book.publicationDate')}
              ...
              <ValidatedField
                ...
                name="author"
                data-cy="author"
                label={translate('jhipsterSampleApplicationSqlApp.book.author')}
                type="select"
              >
                <option value="" key="0" />
                {authors
              ...
              <ValidatedField
                ...
                name="genre"
                data-cy="genre"
                label={translate('jhipsterSampleApplicationSqlApp.book.genre')}
                type="select"
              >
                <option value="" key="0" />
                {genres
