  ...
  return (
    <div>
      <h2 id="genre-heading" data-cy="GenreHeading">
        <Translate contentKey="jhipsterSampleApplicationSqlApp.genre.home.title">Genres</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="jhipsterSampleApplicationSqlApp.genre.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/genre/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhipsterSampleApplicationSqlApp.genre.home.createLabel">Create new Genre</Translate>
          </Link>
        </div>
      </h2>
          ...
          {genreList && genreList.length > 0 ? (
              ...
              <thead>
                <tr>
                  <th className="hand" onClick={sort('id')}>
                    <Translate contentKey="jhipsterSampleApplicationSqlApp.genre.id">ID</Translate>{' '}
                  ...
                  <th className="hand" onClick={sort('decription')}>
                    <Translate contentKey="jhipsterSampleApplicationSqlApp.genre.decription">Decription</Translate>{' '}
                    <FontAwesomeIcon icon={getSortIconByFieldName('decription')} />
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="jhipsterSampleApplicationSqlApp.genre.home.notFound">No Genres found</Translate>
              </div>
            )
          )}
        </InfiniteScroll>
